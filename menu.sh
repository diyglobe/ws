...
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   " \e[36m Traffic\e[m       \e[36mToday      Yesterday     Month"
echo -e   " \e[36m Download\e[m      $dtoday    $dyest        $dmon   \e[0m"
echo -e   " \e[36m Upload\e[m           $utoday      $uyest       $umon   \e[0m"
echo -e   " \e[36m Total\e[m       \033[0;36m  $ttoday    $tyest       $tmon  \e[0m"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   " \e[$back_text                \e[30m[\e[$box Premium VPS By @DIYVPN"\e[30m ]\e[1m                       \e[m"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
