...
EOF
cat>/usr/local/etc/xray/$user-tls1.json<<EOF
      {
      "v": "2",
      "ps": "${user}",
      "add": "${sts}${domain}",
...
EOF
cat>/usr/local/etc/xray/$user-none1.json<<EOF
      {
      "v": "2",
      "ps": "${user}",
      "add": "${sts}${domain}",
...
vmesslink3="vmess://$(base64 -w 0 /usr/local/etc/xray/$user-tls1.json)"
vmesslink4="vmess://$(base64 -w 0 /usr/local/etc/xray/$user-none1.json)"
...
vlesslink3="vless://${uuid}@${sts}${domain}:$tls?path=$patchtls&security=tls&encryption=none&type=ws&sni=$sni#${user}"
vlesslink4="vless://${uuid}@${sts}${domain}:$none?path=$patchnontls&encryption=none&host=$sni&type=ws#${user}"
systemctl restart xray
systemctl restart xray@none
clear
echo -e ""
...
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "Link TLS         : ${vlesslink3}"
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "Link None TLS    : ${vlesslink4}"
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "Created   : $harini"
echo -e "Expired   : $exp"
echo -e "Script By $creditt"
